...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-68767047-1"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	  gtag('config', 'UA-68767047-1');
	</script>
...
<body>
    <main>
	<div class="uk-navbar-container uk-navbar-transparent cs-nav uk-background-cover uk-light uk-padding-small uk-background-bottom-center" uk-navbar style="background-image: url(/img/header_blur.jpg);">
	    <div class="uk-navbar-center">
	        <div class="uk-navbar-center-left"><div>
	           <ul class="uk-navbar-nav">
	                <li class="uk-padding uk-padding-remove-vertical"><a href="/about/">About</a></li>
	                <li class="uk-padding uk-padding-remove-vertical"><a href="/services/">Services</a></li>
	           </ul>
	        </div></div>
	        ...
	        <div class="uk-navbar-center-right"><div>
	           <ul class="uk-navbar-nav">
	                <li class="uk-padding uk-padding-remove-vertical"><a href="/blog/">Blog</a></li>
	                <li class="uk-padding uk-padding-remove-vertical"><a href="/support/">Support</a></li>
	           </ul>
	        </div></div>
	    </div>
	</div>